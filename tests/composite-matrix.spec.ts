...
describe('composite matrix', () => {
  describe('createComposite', () => {
    test('5x3', () => {
      let i = 1
      expect(createCompositeMatrix(5, 3, () => i++)).toEqual(stub5x3)
    })

    test('5x4', () => {
      let i = 1
      expect(createCompositeMatrix(5, 4, () => i++)).toEqual(stub5x4)
    })

    test('5x5', () => {
      let i = 1
      expect(createCompositeMatrix(5, 5, () => i++)).toEqual(stub5x5)
    })
  })
