...
import { CubeFace, CubeSticker, CubeTurn, CubeStateSummary } from '../src/cube/cube';
...
describe('cube', () => {
  ...
  const simplifiedState = (cube: Cube<Data>): CubeStateSummary => ({
